...
def generate_ai_response(crime_data, city):
    ...
    prompt = f"""Crime data for {city}: violent crimes include {violent_crime_list}, and property crimes include {property_crime_list}. Please provide an easy-to-understand summary of the differences between national and {city}'s crime rates. Also, please share the three most dangerous areas within {city}, explain why they are dangerous, and provide safety tips related to the most common crime rates in those areas. Please use Tailwind CSS and HTML to format your response (full width, no background color)."""
